...
arguments_strIn = r'E:\FYP final\testRun\shadows_out1.png'
arguments_strOut = './hed.png'
...
if __name__ == '__main__':
    ...
    im=PIL.Image.fromarray((tenOutput.clip(0.0, 1.0).numpy().transpose(1, 2, 0)[:, :, 0] * 255.0).astype(numpy.uint8))
    im_invert = ImageOps.invert(im)
    im_invert.save(arguments_strOut)
    im_invert.show()
